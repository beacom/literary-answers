...
### 1.2-4
Consider the problem of evaluating a polynomial at a point. Given n coefficients a<sub>0</sub>, a<sub>1</sub>,...,a<sub>n - 1</sub> and a real number _x_, we wish to compute $\displaystyle\sum_{i=0}^{n-1} a_i x_i $
