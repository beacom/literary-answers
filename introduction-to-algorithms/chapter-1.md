...
Insertion sort would take Θ(n^2) to sort all _n_ elements, but it is not sorting every element, but rather _n_/_k_ sets of elements. So there will be _n_/_k_ executions of Θ((n/k)^2). 
